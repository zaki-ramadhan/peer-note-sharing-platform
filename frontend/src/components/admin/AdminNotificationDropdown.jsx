...
const AdminNotificationDropdown = ({ isOpen, onClose, onUnreadCountChange }) => {
    ...
    return (
        <div className="absolute right-0 mt-2 w-96 bg-gray-800/95 backdrop-blur-lg border border-gray-700/50 rounded-xl shadow-xl max-h-96 overflow-hidden z-50">
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700/50">
                <div className="flex items-center space-x-2">
                    <Bell className="h-5 w-5 text-blue-400" />
                    <h3 className="text-sm font-semibold text-white">Notifikasi Admin</h3>
                    {unreadCount > 0 && (
                                            ...
                                            <div className="divide-y divide-gray-700/50">
                                                {unreadNotifications.map((notification) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={notification.id}
                                                            className="group relative px-4 py-3 hover:bg-gray-700/30 transition-colors bg-gray-700/20"
                                                        >
                                                                ...
                                                                <div className="flex-1 min-w-0">
                                                                    <div className="flex items-start justify-between">
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className="flex-shrink-0 p-1 text-gray-500 hover:text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity"
                                                                        >
                                                                            <X className="h-3 w-3" />
                                                                        </button>
                                                                    </div>
                                            ...
                                            <div className="divide-y divide-gray-700/50">
                                                {readNotifications.map((notification) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={notification.id}
                                                            className="group relative px-4 py-3 hover:bg-gray-700/30 transition-colors"
                                                        >
                                                            <div className="flex items-start space-x-3">
                                                                <div className={`flex-shrink-0 p-2 rounded-lg ${getPriorityColor(notification.priority)} opacity-60`}>
                                                                    <Icon className="h-4 w-4" />
                                                                </div>
                                                                <div className="flex-1 min-w-0">
                                                                    <div className="flex items-start justify-between">
            ...
            {notifications.length > 0 && (
                <div className="border-t border-gray-700/50 bg-gray-800/50">
                    ...
                    {notifications.length > 0 && unreadCount === 0 && (
                        <div className="px-3 py-2 border-t border-gray-700/50 bg-red-900/10">
                            <button
                                onClick={deleteAllNotifications}
                                className="w-full flex items-center justify-center space-x-2 px-4 py-3 text-sm text-red-400 hover:text-red-300 hover:bg-red-900/30 rounded-lg transition-all duration-200 font-medium border border-red-700/50 hover:border-red-600/70"
                                title="Hapus semua notifikasi"
                            >
