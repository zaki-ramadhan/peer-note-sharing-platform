...
const NoteCard = ({
  ...
  if (mini) {
    return (
      <Card
        variant="glass"
        className="h-full flex flex-col transition-all duration-300 border border-white/20 font-['Hanken_Grotesk']"
      >
        <CardContent className="p-4 flex-1 flex flex-col">
          <div className="text-center flex-1 flex flex-col">
            <div
              className={`w-12 h-12 bg-gradient-to-br ${getSubjectGradient(
                subject
              )} rounded-lg flex items-center justify-center shadow-md mx-auto mb-3`}
            >
        ...
        <CardContent className="p-5 flex-1">
          <div className="flex items-start space-x-4 h-full">
            <div className="flex-shrink-0">
              <div
                className={`w-16 h-16 bg-gradient-to-br ${getSubjectGradient(
                  subject
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-between h-full">
              <div className="flex-1">
                ...
                <p className="text-base text-gray-600 mb-3 min-h-[1.5rem]">
                  {subject}
                </p>
              </div>
  ...
  return (
    <Card
      variant="elevated"
      className="group h-full flex flex-col transition-all duration-500 overflow-hidden font-['Hanken_Grotesk']"
    >
      {/* Header with gradient and thumbnail */}
      <div className="relative">
        <div
          className={`h-48 bg-gradient-to-br ${getSubjectGradient(
            subject
      ...
      <CardContent className="p-6 flex-1 flex flex-col">
        ...
        <div className="flex items-center space-x-3 mt-auto">
          <Button className="flex-1" size="md" onClick={handleDownload}>
          ...
          <Button
            ...
            className="px-4"
            title="View details"
            onClick={() => onViewDetails && onViewDetails(note)}
          >
            <Eye className="w-4 h-4" />
          </Button>
        </div>
