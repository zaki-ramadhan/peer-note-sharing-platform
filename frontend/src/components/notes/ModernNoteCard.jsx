...
import { Card, CardContent } from '../ui/ModernCard';
import { Button } from '../ui';
import { Badge, Avatar } from '../ui';
import { formatDistanceToNow } from 'date-fns';

const ModernNoteCard = ({ note, onDownload, onRate, compact = false }) => {
    const {
        id,
        title,
        description,
    ...
    if (compact) {
        return (
            <Card variant="glass" className="hover:shadow-xl transition-all duration-300 border border-white/20">
