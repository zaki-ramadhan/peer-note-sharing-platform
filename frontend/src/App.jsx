      ...
      <NotificationProvider>
        <FavoritesProvider>
          <Routes>
            ...
            <Route path="/notes" element={<NotesPage />} />            <Route path="/upload" element={<UploadPage />} />
            <Route path="/forum" element={<ForumPage />} />
            <Route path="/forum/create" element={<CreatePostPage />} />          <Route path="/leaderboard" element={<LeaderboardPage />} />
