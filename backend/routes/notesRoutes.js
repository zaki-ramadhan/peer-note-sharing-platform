...
let notes = [
  {
    ...
    description:
      "Comprehensive guide covering useState, useEffect, and custom hooks",
    ...
    thumbnail:
      "https://via.placeholder.com/300x400/3B82F6/FFFFFF?text=React+Hooks",
  },
  {
    id: 2,
    title: "Advanced JavaScript Concepts",
    description:
      "Deep dive into closures, prototypes, async/await, and ES6+ features",
    subject: "Computer Science",
    author: {
      id: 2,
      name: "Jane Smith",
    ...
    thumbnail:
      "https://via.placeholder.com/300x400/9333EA/FFFFFF?text=JavaScript",
  },
];
  ...
  try {
    ...
    const newNote = {
      ...
      author: {
        ...
        name: "Current User",
        avatar:
          "https://ui-avatars.com/api/?name=Current+User&background=3B82F6&color=fff",
      },
      ...
      tags: tags || [],
      thumbnail: `https://via.placeholder.com/300x400/3B82F6/FFFFFF?text=${encodeURIComponent(
        title
      )}`,
    };
